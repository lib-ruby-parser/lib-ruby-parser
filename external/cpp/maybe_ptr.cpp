...
extern "C"
{
    MAYBE_PTR_BLOB lib_ruby_parser__internal__containers___maybe_ptr__make(void *raw) noexcept
    {
        return PACK(MAYBE_PTR((DUMMY_MAYBE_PTR_VALUE *)raw));
    }

    void lib_ruby_parser__internal__containers___maybe_ptr__free(MAYBE_PTR_BLOB maybe_ptr_blob, DropPtrInPlace drop_ptr_in_place) noexcept
    {
    ...
    void *lib_ruby_parser__internal__containers___maybe_ptr__get_raw(MAYBE_PTR_BLOB maybe_ptr_blob) noexcept
    {

...
<each-node-field><dnl>
<helper node-field-cpp-field-type> <helper node-field-c-name><if node-field-is-last><else>, </if><dnl>
</each-node-field>) : <each-node-field><dnl>
<helper node-field-c-name>(std::move(<helper node-field-c-name>))<if node-field-is-last><else>, </if><dnl>
</each-node-field> {};
</each-node><dnl>

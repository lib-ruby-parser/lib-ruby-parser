...
<helper constructor-sig>
{
    LIB_RUBY_PARSER_DiagnosticMessage message = {
        ...
        .as = { .<helper message-lower-name> = { <helper constructor-initialize-list> } }
    };
...
{
    const LIB_RUBY_PARSER_<helper field-message-camelcase-name> *self = (const LIB_RUBY_PARSER_<helper field-message-camelcase-name> *)self_blob;
    return (const <helper message-field-c-blob-type> *)(&(self-><helper message-field-name>));
}
</each-message-field><dnl>
</each-message>
